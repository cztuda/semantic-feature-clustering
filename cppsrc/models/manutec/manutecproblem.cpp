...
BOOST_CLASS_EXPORT_IMPLEMENT(ManutecProblem)


extern "C" OptimalControlProblem* create_default() {
    OptimalControlProblem* p = new ManutecProblem();
    p->initialize();    
    return p;
}
extern "C" OptimalControlProblem* create_copy(const OptimalControlProblem* p) {
    const ManutecProblem* pcast = dynamic_cast<const ManutecProblem*>(p);
    if(!pcast) return 0;
    OptimalControlProblem* p2 = new ManutecProblem(*pcast);
    p2->initialize(); 
    return p2;
}
...
long ManutecProblem::derivativeLibraryInstanceCounter = 0;
std::unique_ptr<CppAD::cg::LinuxDynamicLib<double>> ManutecProblem::derivativeLibrary = 0;


void ManutecProblem::initialize()
{
    DEF def;
...
void ManutecProblem::manageDerivativeLibrary()
{
    if(ManutecProblem::derivativeLibraryInstanceCounter > 0)
        ManutecProblem::derivativeLibraryInstanceCounter++;        
    if(ManutecProblem::derivativeLibraryInstanceCounter == 0) 
    {
        if(CppAD::cg::system::isFile("manutecDerivatives.so")) {
            ManutecProblem::derivativeLibrary = std::unique_ptr<CppAD::cg::LinuxDynamicLib<double>>( new CppAD::cg::LinuxDynamicLib<double>("manutecDerivatives.so") );
            ManutecProblem::derivativeLibraryInstanceCounter++; 
        } else {
            ManutecProblem::derivativeLibraryInstanceCounter = -1;
        }
    } 
}

std::string ofc::models::ManutecProblem::getThisLibraryPathname() const
{
    Dl_info info;
...
ManutecProblem::ManutecProblem() : OptimalControlProblem(DIM_X, DIM_U)
{
    manageDerivativeLibrary();
};

ManutecProblem::ManutecProblem(const ManutecProblem& p) : OptimalControlProblem(p) 
{
    manageDerivativeLibrary();
};

ofc::models::ManutecProblem::~ManutecProblem()
{
    if(this->derivativeLibraryInstanceCounter > 0)
        this->derivativeLibraryInstanceCounter--;
    if(this->derivativeLibraryInstanceCounter == 0)
        ManutecProblem::derivativeLibrary = 0;
}



int ofc::models::ManutecProblem::getNumberOfImplicitNonlinearBoundaryConditions() const
{ return DIM_IBC;}
int ofc::models::ManutecProblem::getNumberOfEqualityConstraints() const
{ return DIM_EQC;}
int ofc::models::ManutecProblem::getNumberOfInequalityConstraints() const
{ return DIM_INEQC;}


bool ManutecProblem::objectiveMayerTerm(double& fobj, double tf, uint nx, uint nu, uint np, const double* x0, const double* u0, const double* p, const double* xf, const double* uf) const {
...
bool ManutecProblem::objectiveLagrangeTermIntegrand(double& fobj, uint nx, uint nu, uint np, const double* x, const double* u, const double* p) const {
...
bool ManutecProblem::evaluate(double* f, const double* state, const double* control, const double* parameter, uint nx, uint nu, uint np) const {
...
bool ofc::models::ManutecProblem::NonlinearEqualityConstraints(double* nec, const double* state, const double* control, const double* parameter, uint nx, uint nu, uint np) const
{
...
bool ofc::models::ManutecProblem::NonlinearInequalityConstraints(double* nec, const double* state, const double* control, const double* parameter, uint nx, uint nu, uint np) const
{
...
bool ofc::models::ManutecProblem::NonlinearBoundaryConditions(double* xf, double* uf, const double* x0, const double* u0, const double* p, double t0, double tf, uint nx, uint nu, uint np) const
{
    return true;
}

bool ofc::models::ManutecProblem::implicitNonlinearBoundaryConditions(double* rb, const double* x0, const double* u0, const double* p, double* xf, double* uf, double t0, double tf, uint nx, uint nu, uint np, uint nrb) const
{
    return true;
}
...
bool ofc::models::ManutecProblem::dynamicsJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::ManutecProblem::objectiveLagrangeJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
    if(this->derivativeLibraryInstanceCounter < 0) return false;
...
bool ofc::models::ManutecProblem::objectiveMayerJacobians(double* J_x0, double* J_u0, double* J_c, double* J_p, double* J_xf, double* J_uf, double* J_tf, const double* state_t0, const double* control_t0, const double* parameter, const double tf, const double* state_tf, const double* control_tf, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::ManutecProblem::NECJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::ManutecProblem::NICJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::ManutecProblem::NBCJacobians(double* J_x0, double* J_u0, double* J_c, double* J_p, double* J_xf, double* J_uf, double* J_tf, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np, const double* x0, const double* u0, const double* p, double t0, double tf, double* xf, double* uf) const
{
