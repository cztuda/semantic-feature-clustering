...
namespace ofc::models {
    ...
    class ManutecProblem : public OptimalControlProblem
    {
    public:
        ManutecProblem();
        ManutecProblem(const ManutecProblem& p);
        ~ManutecProblem();
        ...
        {
            OptimalControlProblem* o = new ManutecProblem(*this);
            return o;
        }
...
BOOST_CLASS_EXPORT_KEY(ofc::models::ManutecProblem)
