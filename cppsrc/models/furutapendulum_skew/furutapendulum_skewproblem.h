...
namespace ofc::models {
    ...
    class Furutapendulum_skewProblem : public OptimalControlProblem
    {
    public:
        Furutapendulum_skewProblem();
        Furutapendulum_skewProblem(const Furutapendulum_skewProblem& p);
        ~Furutapendulum_skewProblem();
        ...
        {
            OptimalControlProblem* o = new Furutapendulum_skewProblem(*this);
            return o;
        }
...
BOOST_CLASS_EXPORT_KEY(ofc::models::Furutapendulum_skewProblem)
