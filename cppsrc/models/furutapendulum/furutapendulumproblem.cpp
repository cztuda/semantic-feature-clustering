...
#include "furutapendulumproblem.h"
...
BOOST_CLASS_EXPORT_IMPLEMENT(FurutaPendulumProblem)



extern "C" OptimalControlProblem* create_default() {    
    OptimalControlProblem* p = new FurutaPendulumProblem();
    p->initialize();    
    return p;
}
extern "C" OptimalControlProblem* create_copy(const OptimalControlProblem* p) {
    const FurutaPendulumProblem* pcast = dynamic_cast<const FurutaPendulumProblem*>(p);
    if(!pcast) return 0;
    OptimalControlProblem* p2 = new FurutaPendulumProblem(*pcast);
    p2->initialize(); 
    return p2;
}
...
long FurutaPendulumProblem::derivativeLibraryInstanceCounter = 0;
std::unique_ptr<CppAD::cg::LinuxDynamicLib<double>> FurutaPendulumProblem::derivativeLibrary = 0;


void FurutaPendulumProblem::initialize()
{
    DEF def;
...
void FurutaPendulumProblem::manageDerivativeLibrary()
{
    if(FurutaPendulumProblem::derivativeLibraryInstanceCounter > 0)
        FurutaPendulumProblem::derivativeLibraryInstanceCounter++;        
    if(FurutaPendulumProblem::derivativeLibraryInstanceCounter == 0) 
    {
        if(CppAD::cg::system::isFile("furutapendulumDerivatives.so")) {
            FurutaPendulumProblem::derivativeLibrary = std::unique_ptr<CppAD::cg::LinuxDynamicLib<double>>( new CppAD::cg::LinuxDynamicLib<double>("furutapendulumDerivatives.so") );
            FurutaPendulumProblem::derivativeLibraryInstanceCounter++;   
        } else {
            FurutaPendulumProblem::derivativeLibraryInstanceCounter = -1;
        }
    } 
}

std::string ofc::models::FurutaPendulumProblem::getThisLibraryPathname() const
{
    Dl_info info;
...
FurutaPendulumProblem::FurutaPendulumProblem() : OptimalControlProblem(DIM_X, DIM_U)
{
    manageDerivativeLibrary();
};

FurutaPendulumProblem::FurutaPendulumProblem(const FurutaPendulumProblem& p) : OptimalControlProblem(p) 
{
    manageDerivativeLibrary();
};

ofc::models::FurutaPendulumProblem::~FurutaPendulumProblem()
{
    if(this->derivativeLibraryInstanceCounter > 0)
        this->derivativeLibraryInstanceCounter--;
    if(this->derivativeLibraryInstanceCounter == 0)
        FurutaPendulumProblem::derivativeLibrary = 0;
}



int ofc::models::FurutaPendulumProblem::getNumberOfImplicitNonlinearBoundaryConditions() const
{ return DIM_IBC;}
int ofc::models::FurutaPendulumProblem::getNumberOfEqualityConstraints() const
{ return DIM_EQC;}
int ofc::models::FurutaPendulumProblem::getNumberOfInequalityConstraints() const
{ return DIM_INEQC;}


bool FurutaPendulumProblem::objectiveMayerTerm(double& fobj, double tf, uint nx, uint nu, uint np, const double* x0, const double* u0, const double* p, const double* xf, const double* uf) const {
...
bool FurutaPendulumProblem::objectiveLagrangeTermIntegrand(double& fobj, uint nx, uint nu, uint np, const double* x, const double* u, const double* p) const {
...
bool FurutaPendulumProblem::evaluate(double* f, const double* state, const double* control, const double* parameter, uint nx, uint nu, uint np) const {
...
bool ofc::models::FurutaPendulumProblem::NonlinearEqualityConstraints(double* nec, const double* state, const double* control, const double* parameter, uint nx, uint nu, uint np) const
{
...
bool ofc::models::FurutaPendulumProblem::NonlinearInequalityConstraints(double* nec, const double* state, const double* control, const double* parameter, uint nx, uint nu, uint np) const
{
...
bool ofc::models::FurutaPendulumProblem::NonlinearBoundaryConditions(double* xf, double* uf, const double* x0, const double* u0, const double* p, double t0, double tf, uint nx, uint nu, uint np) const
{
    return true;
}

bool ofc::models::FurutaPendulumProblem::implicitNonlinearBoundaryConditions(double* rb, const double* x0, const double* u0, const double* p, double* xf, double* uf, double t0, double tf, uint nx, uint nu, uint np, uint nrb) const
{
    return true;
}
...
bool ofc::models::FurutaPendulumProblem::dynamicsJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::FurutaPendulumProblem::objectiveLagrangeJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
    if(this->derivativeLibraryInstanceCounter < 0) return false;
...
bool ofc::models::FurutaPendulumProblem::objectiveMayerJacobians(double* J_x0, double* J_u0, double* J_c, double* J_p, double* J_xf, double* J_uf, double* J_tf, const double* state_t0, const double* control_t0, const double* parameter, const double tf, const double* state_tf, const double* control_tf, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::FurutaPendulumProblem::NECJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::FurutaPendulumProblem::NICJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::FurutaPendulumProblem::NBCJacobians(double* J_x0, double* J_u0, double* J_c, double* J_p, double* J_xf, double* J_uf, double* J_tf, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np, const double* x0, const double* u0, const double* p, double t0, double tf, double* xf, double* uf) const
{
