...
template<class Type, class Array, class constArray>
void constraint_NBC(Array state_tf, Array control_tf, Type t0, Type tf, constArray state_t0, constArray control_t0, constArray constants, constArray parameter, const unsigned int nx, const unsigned int nu, const unsigned int nc, const unsigned int np) 
{
};
