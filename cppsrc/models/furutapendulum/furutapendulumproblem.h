...
namespace ofc::models {
    ...
    class FurutaPendulumProblem : public OptimalControlProblem
    {
    public:
        FurutaPendulumProblem();
        FurutaPendulumProblem(const FurutaPendulumProblem& p);
        ~FurutaPendulumProblem();
        ...
        {
            OptimalControlProblem* o = new FurutaPendulumProblem(*this);
            return o;
        }
...
BOOST_CLASS_EXPORT_KEY(ofc::models::FurutaPendulumProblem)
