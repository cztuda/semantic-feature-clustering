...
BOOST_CLASS_EXPORT_IMPLEMENT(Furutapendulum_smoothProblem)


extern "C" OptimalControlProblem* create_default() {
    OptimalControlProblem* p = new Furutapendulum_smoothProblem();
    p->initialize();    
    return p;
}
extern "C" OptimalControlProblem* create_copy(const OptimalControlProblem* p) {
    const Furutapendulum_smoothProblem* pcast = dynamic_cast<const Furutapendulum_smoothProblem*>(p);
    if(!pcast) return 0;
    OptimalControlProblem* p2 = new Furutapendulum_smoothProblem(*pcast);
    p2->initialize(); 
    return p2;
}
...
long Furutapendulum_smoothProblem::derivativeLibraryInstanceCounter = 0;
std::unique_ptr<CppAD::cg::LinuxDynamicLib<double>> Furutapendulum_smoothProblem::derivativeLibrary = 0;


void Furutapendulum_smoothProblem::initialize()
{
    DEF def;
...
void Furutapendulum_smoothProblem::manageDerivativeLibrary()
{
    if(Furutapendulum_smoothProblem::derivativeLibraryInstanceCounter > 0)
        Furutapendulum_smoothProblem::derivativeLibraryInstanceCounter++;
    if(Furutapendulum_smoothProblem::derivativeLibraryInstanceCounter == 0) 
    {
        if(CppAD::cg::system::isFile("furutapendulum_smoothDerivatives.so")) {
            Furutapendulum_smoothProblem::derivativeLibrary = std::unique_ptr<CppAD::cg::LinuxDynamicLib<double>>( new CppAD::cg::LinuxDynamicLib<double>("furutapendulum_smoothDerivatives.so") );
            Furutapendulum_smoothProblem::derivativeLibraryInstanceCounter++;
        } else {
            Furutapendulum_smoothProblem::derivativeLibraryInstanceCounter = -1;
        }
    } 
}

std::string ofc::models::Furutapendulum_smoothProblem::getThisLibraryPathname() const
{
    Dl_info info;
...
Furutapendulum_smoothProblem::Furutapendulum_smoothProblem() : OptimalControlProblem(DIM_X, DIM_U)
{
    manageDerivativeLibrary();
};

Furutapendulum_smoothProblem::Furutapendulum_smoothProblem(const Furutapendulum_smoothProblem& p) : OptimalControlProblem(p) 
{
    manageDerivativeLibrary();
};

ofc::models::Furutapendulum_smoothProblem::~Furutapendulum_smoothProblem()
{
    if(this->derivativeLibraryInstanceCounter > 0)
        this->derivativeLibraryInstanceCounter--;
    if(this->derivativeLibraryInstanceCounter == 0)
        Furutapendulum_smoothProblem::derivativeLibrary = 0;
}



int ofc::models::Furutapendulum_smoothProblem::getNumberOfImplicitNonlinearBoundaryConditions() const
{ return DIM_IBC;}
int ofc::models::Furutapendulum_smoothProblem::getNumberOfEqualityConstraints() const
{ return DIM_EQC;}
int ofc::models::Furutapendulum_smoothProblem::getNumberOfInequalityConstraints() const
{ return DIM_INEQC;}


bool Furutapendulum_smoothProblem::objectiveMayerTerm(double& fobj, double tf, uint nx, uint nu, uint np, const double* x0, const double* u0, const double* p, const double* xf, const double* uf) const {
...
bool Furutapendulum_smoothProblem::objectiveLagrangeTermIntegrand(double& fobj, uint nx, uint nu, uint np, const double* x, const double* u, const double* p) const {
...
bool Furutapendulum_smoothProblem::evaluate(double* f, const double* state, const double* control, const double* parameter, uint nx, uint nu, uint np) const {
...
bool ofc::models::Furutapendulum_smoothProblem::NonlinearEqualityConstraints(double* nec, const double* state, const double* control, const double* parameter, uint nx, uint nu, uint np) const
{
...
bool ofc::models::Furutapendulum_smoothProblem::NonlinearInequalityConstraints(double* nec, const double* state, const double* control, const double* parameter, uint nx, uint nu, uint np) const
{
...
bool ofc::models::Furutapendulum_smoothProblem::NonlinearBoundaryConditions(double* xf, double* uf, const double* x0, const double* u0, const double* p, double t0, double tf, uint nx, uint nu, uint np) const
{
    return true;
}

bool ofc::models::Furutapendulum_smoothProblem::implicitNonlinearBoundaryConditions(double* rb, const double* x0, const double* u0, const double* p, double* xf, double* uf, double t0, double tf, uint nx, uint nu, uint np, uint nrb) const
{
    return true;
}
...
bool ofc::models::Furutapendulum_smoothProblem::dynamicsJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::Furutapendulum_smoothProblem::objectiveLagrangeJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
    if(this->derivativeLibraryInstanceCounter < 0) return false;
...
bool ofc::models::Furutapendulum_smoothProblem::objectiveMayerJacobians(double* J_x0, double* J_u0, double* J_c, double* J_p, double* J_xf, double* J_uf, double* J_tf, const double* state_t0, const double* control_t0, const double* parameter, const double tf, const double* state_tf, const double* control_tf, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::Furutapendulum_smoothProblem::NECJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::Furutapendulum_smoothProblem::NICJacobians(double* J_x, double* J_u, double* J_c, double* J_p, const double* state, const double* control, const double* parameter, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np) const
{
...
bool ofc::models::Furutapendulum_smoothProblem::NBCJacobians(double* J_x0, double* J_u0, double* J_c, double* J_p, double* J_xf, double* J_uf, double* J_tf, ofc::models::uint nx, ofc::models::uint nu, ofc::models::uint np, const double* x0, const double* u0, const double* p, double t0, double tf, double* xf, double* uf) const
{
